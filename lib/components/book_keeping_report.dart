...
class BookKeepingReport extends StatefulWidget {
  ...
  @override
  State<BookKeepingReport> createState() => _BookKeepingReportState();
}

class _BookKeepingReportState extends State<BookKeepingReport> {
  // Filter values
  String _location = 'All';
  String _userDivision = 'All';
  String _user = 'All';
  String _account = 'Other';
  String _task = 'Other';
  DateTime? _startDate;
  DateTime? _endDate;
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    InputDropDown(
                      value: _account,
                      items: ['Other', 'ABC', 'XYZ', 'Main', 'Secondary'],
                      onChanged: (value) {
                        if (value != null) {
                          setState(() {
                            _account = value;
